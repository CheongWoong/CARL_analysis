...
if __name__ == "__main__":
    ...
    run_name = f"test/seed_{training_seed}/{args.env_id}/{args.env_config_id}/{args.test_single_context_id}/{args.exp_name}"
    if args.track:
        import wandb
    ...
    checkpoint_idx = args.total_timesteps
    ...
    while num_episodes < args.total_episodes:
        ...
        if "final_info" in infos:
            for info in infos["final_info"]:
                ...
                writer.add_scalar("charts/episodic_return", episodic_return, num_episodes)
                writer.add_scalar("charts/episodic_length", episodic_length, num_episodes)
